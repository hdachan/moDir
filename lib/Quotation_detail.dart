                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Container(
                                        width: 182,
                                        height: 17,
                                        color: Colors.yellow, // 세 번째 내부 컨테이너 색상 (원하는 색상으로 조정 가능)
                                      ),
                                      SizedBox(height: 8),
                                      Container(
                                        width: 182,
...
class TabContent2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Center(child: Text('커뮤니티 탭 내용'));
  }
}
